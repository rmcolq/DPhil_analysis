...
vim /nfs/leia/research/iqbal/rmcolq/git/DPhil_analysis/data/4way_illumina.tsv
vim /nfs/leia/research/iqbal/rmcolq/git/DPhil_analysis/data/4way_illumina.30x.tsv
vim /nfs/leia/research/iqbal/rmcolq/git/DPhil_analysis/data/4way_nanopore.tsv
...
for id in H131800734 H151080744 CFT073 RHB10-C07
do
mkdir -p /hps/nobackup/iqbal/rmcolq/projects/DPhil_analysis/analysis/4_way/genotyping/$id
...
less /hps/nobackup/iqbal/rmcolq/projects/DPhil_analysis/analysis/pandora_compare/6_way/190519/$run/pandora_multisample_genotyped.vcf | cut -f1-9,13 > /hps/nobackup/iqbal/rmcolq/projects/DPhil_analysis/analysis/6_way/genotyping/RHB10-C07/pandora_genotyped_$run.vcf
